<?php
    ...
    if($_POST) {
        if(isset($_POST['task-name']) && isset($_POST['task-description'])) {
        ...
        } elseif(isset($_POST['edit'])) echo 'edit'.$_POST['edit'];
                    ...
                    foreach($tasks  as $name=>$value) {
                        ...
                        echo "<div class='row mt-2 '>
                                ...
                                <div class='col d-flex justify-content-center align-items-center gap-1'>
                                    ...
                                    <button type='submit' class='btn btn-primary' name='edit' value='$id'>
